...
<body>
    ...
    <header id="header">
        <div class="container">
            <div class="row">
                <div class="col-md-10">
                    <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span>Portfolio<small>Manage Portfolio Projects</small></h1>
                </div>
                <div class="col-md-2">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading main-color-bg">
                        <h3 class="panel-title">Portfolio Projects</h3>
                    </div>
